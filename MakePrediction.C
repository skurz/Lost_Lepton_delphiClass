...
void MakePrediction()
{
  ...
  Effchain->Add("/nfs/dust/cms/user/kurzsimo/LostLepton/skims_v7/SLe/tree_TTJets_SingleLeptFromTbar.root");
  Effchain->Add("/nfs/dust/cms/user/kurzsimo/LostLepton/skims_v7/SLm/tree_TTJets_SingleLeptFromTbar.root");
