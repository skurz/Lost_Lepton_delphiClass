...
TH2D* saveEff(TH2D* h_ratio){
	...
	gStyle->SetPaintTextFormat("5.4f");
  	...
  	c1->SaveAs(TString("AcceptancePDF/")+name+TString(".pdf"));
  	delete c1;
...
void VaryPDFs(){
	...
	TH2D* ElecAccUnc_NJets4 = new TH2D("ElecAccUnc_NJets4_pass","ElecAccUnc_NJets4_pass",accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
	TH2D* ElecAccUnc_NJets5 = new TH2D("ElecAccUnc_NJets5_pass","ElecAccUnc_NJets5_pass",accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
	TH2D* ElecAccUnc_NJets6 = new TH2D("ElecAccUnc_NJets6_pass","ElecAccUnc_NJets6_pass",accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
	TH2D* ElecAccUnc_NJetsHigh = new TH2D("ElecAccUnc_NJetsHigh_pass","ElecAccUnc_NJetsHigh_pass",accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
	...
	std::vector<TH2D*> h_mu_passHigh(100, 0);
	std::vector<TH2D*> h_mu_failHigh(100, 0);
	...
	std::vector<TH2D*> h_elec_passHigh(100, 0);
	std::vector<TH2D*> h_elec_failHigh(100, 0);
	...
	for(int i = 0; i<h_mu_pass4.size(); ++i){
    			...
    			h_elec_pass4.at(i) = new TH2D(TString("elec_pass4_")+TString(std::to_string(i)),TString("elec_pass4_")+TString(std::to_string(i)),accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
    			h_elec_fail4.at(i) = new TH2D(TString("elec_fail4_")+TString(std::to_string(i)),TString("elec_fail4_")+TString(std::to_string(i)),accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
    			h_elec_pass5.at(i) = new TH2D(TString("elec_pass5_")+TString(std::to_string(i)),TString("elec_pass5_")+TString(std::to_string(i)),accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
    			h_elec_fail5.at(i) = new TH2D(TString("elec_fail5_")+TString(std::to_string(i)),TString("elec_fail5_")+TString(std::to_string(i)),accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
    			h_elec_pass6.at(i) = new TH2D(TString("elec_pass6_")+TString(std::to_string(i)),TString("elec_pass6_")+TString(std::to_string(i)),accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
    			h_elec_fail6.at(i) = new TH2D(TString("elec_fail6_")+TString(std::to_string(i)),TString("elec_fail6_")+TString(std::to_string(i)),accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
    			h_elec_passHigh.at(i) = new TH2D(TString("elec_passHigh_")+TString(std::to_string(i)),TString("elec_passHigh_")+TString(std::to_string(i)),accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
    			h_elec_failHigh.at(i) = new TH2D(TString("elec_failHigh_")+TString(std::to_string(i)),TString("elec_failHigh_")+TString(std::to_string(i)),accHT_-1,AccHT_, accMHT2D_-1,AccMHT2D_);
    }
	...
	for (Long64_t i=0; i<nentries;i++) {
    	...
    	if(muAcc==2){
	    	...
	    	if(NJets > 3.5 && NJets < 4.5) MuAccControl_NJets4_pass->Fill(HT,MHT,Weight);
	  		...
	  		for(int i = 1; i<PDFweights->size(); ++i){
    			mu_pass.at(i-1) += PDFweights->at(i)*Weight;
    			if(NJets > 3.5 && NJets < 4.5) h_mu_pass4.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else if(NJets > 4.5 && NJets < 5.5) h_mu_pass5.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else if(NJets > 5.5 && NJets < 6.5) h_mu_pass6.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else h_mu_passHigh.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
    		}
  		}else if(muAcc==0){
	  		...
	  		for(int i = 1; i<PDFweights->size(); ++i){
    			mu_fail.at(i-1) += PDFweights->at(i)*Weight;
    			if(NJets > 3.5 && NJets < 4.5) h_mu_fail4.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else if(NJets > 4.5 && NJets < 5.5) h_mu_fail5.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else if(NJets > 5.5 && NJets < 6.5) h_mu_fail6.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else h_mu_failHigh.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
    		}
  		}
  		...
  		if(elecAcc==2){
	    	...
	    	if(NJets > 3.5 && NJets < 4.5) ElecAccControl_NJets4_pass->Fill(HT,MHT,Weight);
	  		...
	  		for(int i = 1; i<PDFweights->size(); ++i){
    			elec_pass.at(i-1) += PDFweights->at(i)*Weight;
    			if(NJets > 3.5 && NJets < 4.5) h_elec_pass4.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else if(NJets > 4.5 && NJets < 5.5) h_elec_pass5.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else if(NJets > 5.5 && NJets < 6.5) h_elec_pass6.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else h_elec_passHigh.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
    		}
  		}else if(elecAcc==0){
	  		...
	  		for(int i = 1; i<PDFweights->size(); ++i){
    			elec_fail.at(i-1) += PDFweights->at(i)*Weight;
    			if(NJets > 3.5 && NJets < 4.5) h_elec_fail4.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else if(NJets > 4.5 && NJets < 5.5) h_elec_fail5.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else if(NJets > 5.5 && NJets < 6.5) h_elec_fail6.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
		  		else h_elec_failHigh.at(i-1)->Fill(HT,MHT,PDFweights->at(i)*Weight);
    		}
  		}
	}
	...
	std::vector<TH1D*> h_elec_ratio4(6, 0);
	std::vector<TH1D*> h_elec_ratio5(6, 0);
	std::vector<TH1D*> h_elec_ratio6(6, 0);
	std::vector<TH1D*> h_elec_ratioHigh(6, 0);
	...
	for(int i = 0; i<h_mu_ratio4.size(); ++i){
		...
		h_elec_ratioHigh.at(i) = new TH1D(TString("h_elec_ratioHigh_")+TString(std::to_string(i)),TString("h_elec_ratioHigh_")+TString(std::to_string(i)), 10000, 0., 1.);
	}
	...
	for(int i = 0; i<mu_pass.size(); ++i){
		...
		h_elec_ratioHigh.at(0)->Fill(h_elec_passHigh.at(i)->GetBinContent(1,1)/(h_elec_passHigh.at(i)->GetBinContent(1,1)+h_elec_failHigh.at(i)->GetBinContent(1,1)));
		h_elec_ratioHigh.at(1)->Fill(h_elec_passHigh.at(i)->GetBinContent(2,1)/(h_elec_passHigh.at(i)->GetBinContent(2,1)+h_elec_failHigh.at(i)->GetBinContent(2,1)));
		h_elec_ratioHigh.at(2)->Fill(h_elec_passHigh.at(i)->GetBinContent(3,1)/(h_elec_passHigh.at(i)->GetBinContent(3,1)+h_elec_failHigh.at(i)->GetBinContent(3,1)));
		h_elec_ratioHigh.at(3)->Fill(h_elec_passHigh.at(i)->GetBinContent(1,2)/(h_elec_passHigh.at(i)->GetBinContent(1,2)+h_elec_failHigh.at(i)->GetBinContent(1,2)));
		h_elec_ratioHigh.at(4)->Fill(h_elec_passHigh.at(i)->GetBinContent(2,2)/(h_elec_passHigh.at(i)->GetBinContent(2,2)+h_elec_failHigh.at(i)->GetBinContent(2,2)));
		h_elec_ratioHigh.at(5)->Fill(h_elec_passHigh.at(i)->GetBinContent(3,2)/(h_elec_passHigh.at(i)->GetBinContent(3,2)+h_elec_failHigh.at(i)->GetBinContent(3,2)));
    }

/*  	TCanvas *c1 = new TCanvas("c1","c1",1000,500);
  	c1->Divide(2,1);
  	c1->cd(1);
    h_mu_ratioHigh.at(0)->Draw("");
  	c1->cd(2);
    h_mu_ratioHigh.at(1)->Draw("");
*/
    ...
    ElecAccUnc_NJetsHigh->SetBinContent(1,1, h_elec_ratioHigh.at(0)->GetMean());
    ElecAccUnc_NJetsHigh->SetBinError(1,1, calcEnv(h_elec_ratioHigh.at(0),lower));
    ElecAccUnc_NJetsHigh->SetBinContent(2,1, h_elec_ratioHigh.at(1)->GetMean());
    ElecAccUnc_NJetsHigh->SetBinError(2,1, calcEnv(h_elec_ratioHigh.at(1),lower));
    ElecAccUnc_NJetsHigh->SetBinContent(3,1, h_elec_ratioHigh.at(2)->GetMean());
    ElecAccUnc_NJetsHigh->SetBinError(3,1, calcEnv(h_elec_ratioHigh.at(2),lower));
    ElecAccUnc_NJetsHigh->SetBinContent(1,2, h_elec_ratioHigh.at(3)->GetMean());
    ElecAccUnc_NJetsHigh->SetBinError(1,2, calcEnv(h_elec_ratioHigh.at(3),lower));
    ElecAccUnc_NJetsHigh->SetBinContent(2,2, h_elec_ratioHigh.at(4)->GetMean());
    ElecAccUnc_NJetsHigh->SetBinError(2,2, calcEnv(h_elec_ratioHigh.at(4),lower));
    ElecAccUnc_NJetsHigh->SetBinContent(3,2, h_elec_ratioHigh.at(5)->GetMean());
    ElecAccUnc_NJetsHigh->SetBinError(3,2, calcEnv(h_elec_ratioHigh.at(5),lower));
    ...
    saveEff(ElecAccUnc_NJets4);
    saveEff(ElecAccUnc_NJets5);
    saveEff(ElecAccUnc_NJets6);
    saveEff(ElecAccUnc_NJetsHigh);
