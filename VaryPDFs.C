...
void VaryPDFs(){
	...
	TH2D* MuAccUnc_NJets6 = new TH2D("MuAccPDFUnc_NJets6","MuAccPDFUnc_NJets6",threeDHT_-1,ThreeDHT_, threeDMHT_-1,ThreeDMHT_);
	TH2D* MuAccUnc_NJets78 = new TH2D("MuAccPDFUnc_NJets78","MuAccPDFUnc_NJets78",threeDHT_-1,ThreeDHT_, threeDMHT_-1,ThreeDMHT_);
	...
	TH2D* ElecAccUnc_NJets6 = new TH2D("ElecAccPDFUnc_NJets6","ElecAccPDFUnc_NJets6",threeDHT_-1,ThreeDHT_, threeDMHT_-1,ThreeDMHT_);
	TH2D* ElecAccUnc_NJets78 = new TH2D("ElecAccPDFUnc_NJets78","ElecAccPDFUnc_NJets78",threeDHT_-1,ThreeDHT_, threeDMHT_-1,ThreeDMHT_);
	TH2D* ElecAccUnc_NJets9Inf = new TH2D("ElecAccPDFUnc_NJets9Inf","ElecAccPDFUnc_NJets9Inf",threeDHT_-1,ThreeDHT_, threeDMHT_-1,ThreeDMHT_);
	TH2D* ElecAccUnc_NJets7Inf = new TH2D("ElecAccPDFUnc_NJets7Inf","ElecAccPDFUnc_NJets7Inf",threeDHT_-1,ThreeDHT_, threeDMHT_-1,ThreeDMHT_);

	TH2D* MuAccUnc_Avg = new TH2D("MuAccPDFUnc_Avg","MuAccPDFUnc_Avg",threeDHT_-1,ThreeDHT_, threeDMHT_-1,ThreeDMHT_);
	TH2D* ElecAccUnc_Avg = new TH2D("ElecAccPDFUnc_Avg","ElecAccPDFUnc_Avg",threeDHT_-1,ThreeDHT_, threeDMHT_-1,ThreeDMHT_);

	TH1D* MuAccUnc_NJets = new TH1D("MuAccPDFUnc_NJets","MuAccPDFUnc_NJets",twoDNJets_-1,TwoDNJets_);
	TH1D* ElecAccUnc_NJets = new TH1D("ElecAccPDFUnc_NJets","ElecAccPDFUnc_NJets",twoDNJets_-1,TwoDNJets_);
	...
	std::vector<TH2D*> h_mu_fail4(100, 0);
	std::vector<TH2D*> h_mu_pass5(100, 0);
	std::vector<TH2D*> h_mu_fail5(100, 0);
	std::vector<TH2D*> h_mu_pass6(100, 0);
	std::vector<TH2D*> h_mu_fail6(100, 0);
	std::vector<TH2D*> h_mu_pass78(100, 0);
	std::vector<TH2D*> h_mu_fail78(100, 0);
	std::vector<TH2D*> h_mu_pass9Inf(100, 0);
	std::vector<TH2D*> h_mu_fail9Inf(100, 0);
	std::vector<TH2D*> h_mu_pass7Inf(100, 0);
	std::vector<TH2D*> h_mu_fail7Inf(100, 0);
	...
	std::vector<TH2D*> h_elec_fail4(100, 0);
	std::vector<TH2D*> h_elec_pass5(100, 0);
	std::vector<TH2D*> h_elec_fail5(100, 0);
	std::vector<TH2D*> h_elec_pass6(100, 0);
	std::vector<TH2D*> h_elec_fail6(100, 0);
	std::vector<TH2D*> h_elec_pass78(100, 0);
	std::vector<TH2D*> h_elec_fail78(100, 0);
	std::vector<TH2D*> h_elec_pass9Inf(100, 0);
	std::vector<TH2D*> h_elec_fail9Inf(100, 0);
	std::vector<TH2D*> h_elec_pass7Inf(100, 0);
	std::vector<TH2D*> h_elec_fail7Inf(100, 0);

	std::vector<TH2D*> h_mu_passAvg(100, 0);
	std::vector<TH2D*> h_mu_failAvg(100, 0);
	std::vector<TH2D*> h_elec_passAvg(100, 0);
	std::vector<TH2D*> h_elec_failAvg(100, 0);

	std::vector<TH1D*> h_mu_passNJets(100, 0);
	std::vector<TH1D*> h_mu_failNJets(100, 0);
	std::vector<TH1D*> h_elec_passNJets(100, 0);
	std::vector<TH1D*> h_elec_failNJets(100, 0);
	...
	for (Long64_t i=0; i<nentries;i++) {
    	...
    	if(muAcc==2){
	    	...
	    	switch(NJets){
	  		...
	  		for(unsigned i = 1; i<PDFweights->size(); ++i){
    			mu_pass.at(i-1) += std::abs(PDFweights->at(i)*Weight);
			    ...
			    switch(NJets){
		        	case 3:
			            ...
			            break;
			        case 4:
			        	h_mu_pass4.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 5:
			        	h_mu_pass5.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 6:
			        	h_mu_pass6.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 7:
			        case 8:
			        	h_mu_pass78.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	h_mu_pass7Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        default:
			        	h_mu_pass9Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	h_mu_pass7Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			    }
    		}
	    	...
	    	switch(NJets){
	  		...
	  		for(unsigned i = 1; i<PDFweights->size(); ++i){
    			mu_fail.at(i-1) += std::abs(PDFweights->at(i)*Weight);
    			...
    			switch(NJets){
		        	case 3:
			            ...
			            break;
			        case 4:
			        	h_mu_fail4.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 5:
			        	h_mu_fail5.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 6:
			        	h_mu_fail6.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 7:
			        case 8:
			        	h_mu_fail78.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	h_mu_fail7Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        default:
			        	h_mu_fail9Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	h_mu_fail7Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			    }
    		}
    	...
    	if(elecAcc==2){
	    	...
	    	switch(NJets){
	  		...
	  		for(unsigned i = 1; i<PDFweights->size(); ++i){
    			elec_pass.at(i-1) += std::abs(PDFweights->at(i)*Weight);
			    ...
			    switch(NJets){
		        	case 3:
			            ...
			            break;
			        case 4:
			        	h_elec_pass4.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 5:
			        	h_elec_pass5.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 6:
			        	h_elec_pass6.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 7:
			        case 8:
			        	h_elec_pass78.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	h_elec_pass7Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        default:
			        	h_elec_pass9Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	h_elec_pass7Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			    }
    		}
	    	...
	    	switch(NJets){
	  		...
	  		for(unsigned i = 1; i<PDFweights->size(); ++i){
    			elec_fail.at(i-1) += std::abs(PDFweights->at(i)*Weight);
    			...
    			switch(NJets){
		        	case 3:
			            ...
			            break;
			        case 4:
			        	h_elec_fail4.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 5:
			        	h_elec_fail5.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 6:
			        	h_elec_fail6.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        case 7:
			        case 8:
			        	h_elec_fail78.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	h_elec_fail7Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			        default:
			        	h_elec_fail9Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	h_elec_fail7Inf.at(i-1)->Fill(HT,MHT,std::abs(PDFweights->at(i)*Weight));
			        	break;
			    }
    		}
...
*/
    ...
    MuAccUnc_NJets3->SetBinError(1,1, calcUnc2Max(h_mu_ratio3.at(0)));
    MuAccUnc_NJets3->SetBinContent(2,1, h_mu_ratio3.at(1)->GetMean());
    MuAccUnc_NJets3->SetBinError(2,1, calcUnc2Max(h_mu_ratio3.at(1)));
    MuAccUnc_NJets3->SetBinContent(3,1, h_mu_ratio3.at(2)->GetMean());
    MuAccUnc_NJets3->SetBinError(3,1, calcUnc2Max(h_mu_ratio3.at(2)));
    MuAccUnc_NJets3->SetBinContent(1,2, h_mu_ratio3.at(3)->GetMean());
    MuAccUnc_NJets3->SetBinError(1,2, calcUnc2Max(h_mu_ratio3.at(3)));
    MuAccUnc_NJets3->SetBinContent(2,2, h_mu_ratio3.at(4)->GetMean());
    MuAccUnc_NJets3->SetBinError(2,2, calcUnc2Max(h_mu_ratio3.at(4)));
    MuAccUnc_NJets3->SetBinContent(3,2, h_mu_ratio3.at(5)->GetMean());
    MuAccUnc_NJets3->SetBinError(3,2, calcUnc2Max(h_mu_ratio3.at(5)));
    MuAccUnc_NJets3->SetBinContent(2,3, h_mu_ratio3.at(6)->GetMean());
    MuAccUnc_NJets3->SetBinError(2,3, calcUnc2Max(h_mu_ratio3.at(6)));
    MuAccUnc_NJets3->SetBinContent(3,3, h_mu_ratio3.at(7)->GetMean());
    MuAccUnc_NJets3->SetBinError(3,3, calcUnc2Max(h_mu_ratio3.at(7)));
    MuAccUnc_NJets4->SetBinContent(1,1, h_mu_ratio4.at(0)->GetMean());
    MuAccUnc_NJets4->SetBinError(1,1, calcUnc2Max(h_mu_ratio4.at(0)));
    MuAccUnc_NJets4->SetBinContent(2,1, h_mu_ratio4.at(1)->GetMean());
    MuAccUnc_NJets4->SetBinError(2,1, calcUnc2Max(h_mu_ratio4.at(1)));
    MuAccUnc_NJets4->SetBinContent(3,1, h_mu_ratio4.at(2)->GetMean());
    MuAccUnc_NJets4->SetBinError(3,1, calcUnc2Max(h_mu_ratio4.at(2)));
    MuAccUnc_NJets4->SetBinContent(1,2, h_mu_ratio4.at(3)->GetMean());
    MuAccUnc_NJets4->SetBinError(1,2, calcUnc2Max(h_mu_ratio4.at(3)));
    MuAccUnc_NJets4->SetBinContent(2,2, h_mu_ratio4.at(4)->GetMean());
    MuAccUnc_NJets4->SetBinError(2,2, calcUnc2Max(h_mu_ratio4.at(4)));
    MuAccUnc_NJets4->SetBinContent(3,2, h_mu_ratio4.at(5)->GetMean());
    MuAccUnc_NJets4->SetBinError(3,2, calcUnc2Max(h_mu_ratio4.at(5)));
    MuAccUnc_NJets4->SetBinContent(2,3, h_mu_ratio4.at(6)->GetMean());
    MuAccUnc_NJets4->SetBinError(2,3, calcUnc2Max(h_mu_ratio4.at(6)));
    MuAccUnc_NJets4->SetBinContent(3,3, h_mu_ratio4.at(7)->GetMean());
    MuAccUnc_NJets4->SetBinError(3,3, calcUnc2Max(h_mu_ratio4.at(7)));
    MuAccUnc_NJets5->SetBinContent(1,1, h_mu_ratio5.at(0)->GetMean());
    MuAccUnc_NJets5->SetBinError(1,1, calcUnc2Max(h_mu_ratio5.at(0)));
    MuAccUnc_NJets5->SetBinContent(2,1, h_mu_ratio5.at(1)->GetMean());
    MuAccUnc_NJets5->SetBinError(2,1, calcUnc2Max(h_mu_ratio5.at(1)));
    MuAccUnc_NJets5->SetBinContent(3,1, h_mu_ratio5.at(2)->GetMean());
    MuAccUnc_NJets5->SetBinError(3,1, calcUnc2Max(h_mu_ratio5.at(2)));
    MuAccUnc_NJets5->SetBinContent(1,2, h_mu_ratio5.at(3)->GetMean());
    MuAccUnc_NJets5->SetBinError(1,2, calcUnc2Max(h_mu_ratio5.at(3)));
    MuAccUnc_NJets5->SetBinContent(2,2, h_mu_ratio5.at(4)->GetMean());
    MuAccUnc_NJets5->SetBinError(2,2, calcUnc2Max(h_mu_ratio5.at(4)));
    MuAccUnc_NJets5->SetBinContent(3,2, h_mu_ratio5.at(5)->GetMean());
    MuAccUnc_NJets5->SetBinError(3,2, calcUnc2Max(h_mu_ratio5.at(5)));
    MuAccUnc_NJets5->SetBinContent(2,3, h_mu_ratio5.at(6)->GetMean());
    MuAccUnc_NJets5->SetBinError(2,3, calcUnc2Max(h_mu_ratio5.at(6)));
    MuAccUnc_NJets5->SetBinContent(3,3, h_mu_ratio5.at(7)->GetMean());
    MuAccUnc_NJets5->SetBinError(3,3, calcUnc2Max(h_mu_ratio5.at(7)));
    MuAccUnc_NJets6->SetBinContent(1,1, h_mu_ratio6.at(0)->GetMean());
    MuAccUnc_NJets6->SetBinError(1,1, calcUnc2Max(h_mu_ratio6.at(0)));
    MuAccUnc_NJets6->SetBinContent(2,1, h_mu_ratio6.at(1)->GetMean());
    MuAccUnc_NJets6->SetBinError(2,1, calcUnc2Max(h_mu_ratio6.at(1)));
    MuAccUnc_NJets6->SetBinContent(3,1, h_mu_ratio6.at(2)->GetMean());
    MuAccUnc_NJets6->SetBinError(3,1, calcUnc2Max(h_mu_ratio6.at(2)));
    MuAccUnc_NJets6->SetBinContent(1,2, h_mu_ratio6.at(3)->GetMean());
    MuAccUnc_NJets6->SetBinError(1,2, calcUnc2Max(h_mu_ratio6.at(3)));
    MuAccUnc_NJets6->SetBinContent(2,2, h_mu_ratio6.at(4)->GetMean());
    MuAccUnc_NJets6->SetBinError(2,2, calcUnc2Max(h_mu_ratio6.at(4)));
    MuAccUnc_NJets6->SetBinContent(3,2, h_mu_ratio6.at(5)->GetMean());
    MuAccUnc_NJets6->SetBinError(3,2, calcUnc2Max(h_mu_ratio6.at(5)));
    MuAccUnc_NJets6->SetBinContent(2,3, h_mu_ratio6.at(6)->GetMean());
    MuAccUnc_NJets6->SetBinError(2,3, calcUnc2Max(h_mu_ratio6.at(6)));
    MuAccUnc_NJets6->SetBinContent(3,3, h_mu_ratio6.at(7)->GetMean());
    MuAccUnc_NJets6->SetBinError(3,3, calcUnc2Max(h_mu_ratio6.at(7)));
    MuAccUnc_NJets78->SetBinContent(1,1, h_mu_ratio78.at(0)->GetMean());
    MuAccUnc_NJets78->SetBinError(1,1, calcUnc2Max(h_mu_ratio78.at(0)));
    MuAccUnc_NJets78->SetBinContent(2,1, h_mu_ratio78.at(1)->GetMean());
    MuAccUnc_NJets78->SetBinError(2,1, calcUnc2Max(h_mu_ratio78.at(1)));
    MuAccUnc_NJets78->SetBinContent(3,1, h_mu_ratio78.at(2)->GetMean());
    MuAccUnc_NJets78->SetBinError(3,1, calcUnc2Max(h_mu_ratio78.at(2)));
    MuAccUnc_NJets78->SetBinContent(1,2, h_mu_ratio78.at(3)->GetMean());
    MuAccUnc_NJets78->SetBinError(1,2, calcUnc2Max(h_mu_ratio78.at(3)));
    MuAccUnc_NJets78->SetBinContent(2,2, h_mu_ratio78.at(4)->GetMean());
    MuAccUnc_NJets78->SetBinError(2,2, calcUnc2Max(h_mu_ratio78.at(4)));
    MuAccUnc_NJets78->SetBinContent(3,2, h_mu_ratio78.at(5)->GetMean());
    MuAccUnc_NJets78->SetBinError(3,2, calcUnc2Max(h_mu_ratio78.at(5)));
    MuAccUnc_NJets78->SetBinContent(2,3, h_mu_ratio78.at(6)->GetMean());
    MuAccUnc_NJets78->SetBinError(2,3, calcUnc2Max(h_mu_ratio78.at(6)));
    MuAccUnc_NJets78->SetBinContent(3,3, h_mu_ratio78.at(7)->GetMean());
    MuAccUnc_NJets78->SetBinError(3,3, calcUnc2Max(h_mu_ratio78.at(7)));
    MuAccUnc_NJets9Inf->SetBinContent(1,1, h_mu_ratio9Inf.at(0)->GetMean());
    MuAccUnc_NJets9Inf->SetBinError(1,1, calcUnc2Max(h_mu_ratio9Inf.at(0)));
    MuAccUnc_NJets9Inf->SetBinContent(2,1, h_mu_ratio9Inf.at(1)->GetMean());
    MuAccUnc_NJets9Inf->SetBinError(2,1, calcUnc2Max(h_mu_ratio9Inf.at(1)));
    MuAccUnc_NJets9Inf->SetBinContent(3,1, h_mu_ratio9Inf.at(2)->GetMean());
    MuAccUnc_NJets9Inf->SetBinError(3,1, calcUnc2Max(h_mu_ratio9Inf.at(2)));
    MuAccUnc_NJets9Inf->SetBinContent(1,2, h_mu_ratio9Inf.at(3)->GetMean());
    MuAccUnc_NJets9Inf->SetBinError(1,2, calcUnc2Max(h_mu_ratio9Inf.at(3)));
    MuAccUnc_NJets9Inf->SetBinContent(2,2, h_mu_ratio9Inf.at(4)->GetMean());
    MuAccUnc_NJets9Inf->SetBinError(2,2, calcUnc2Max(h_mu_ratio9Inf.at(4)));
    MuAccUnc_NJets9Inf->SetBinContent(3,2, h_mu_ratio9Inf.at(5)->GetMean());
    MuAccUnc_NJets9Inf->SetBinError(3,2, calcUnc2Max(h_mu_ratio9Inf.at(5)));
    MuAccUnc_NJets9Inf->SetBinContent(2,3, h_mu_ratio9Inf.at(6)->GetMean());
    MuAccUnc_NJets9Inf->SetBinError(2,3, calcUnc2Max(h_mu_ratio9Inf.at(6)));
    MuAccUnc_NJets9Inf->SetBinContent(3,3, h_mu_ratio9Inf.at(7)->GetMean());
    MuAccUnc_NJets9Inf->SetBinError(3,3, calcUnc2Max(h_mu_ratio9Inf.at(7)));
    MuAccUnc_NJets7Inf->SetBinContent(1,1, h_mu_ratio7Inf.at(0)->GetMean());
    MuAccUnc_NJets7Inf->SetBinError(1,1, calcUnc2Max(h_mu_ratio7Inf.at(0)));
    MuAccUnc_NJets7Inf->SetBinContent(2,1, h_mu_ratio7Inf.at(1)->GetMean());
    MuAccUnc_NJets7Inf->SetBinError(2,1, calcUnc2Max(h_mu_ratio7Inf.at(1)));
    MuAccUnc_NJets7Inf->SetBinContent(3,1, h_mu_ratio7Inf.at(2)->GetMean());
    MuAccUnc_NJets7Inf->SetBinError(3,1, calcUnc2Max(h_mu_ratio7Inf.at(2)));
    MuAccUnc_NJets7Inf->SetBinContent(1,2, h_mu_ratio7Inf.at(3)->GetMean());
    MuAccUnc_NJets7Inf->SetBinError(1,2, calcUnc2Max(h_mu_ratio7Inf.at(3)));
    MuAccUnc_NJets7Inf->SetBinContent(2,2, h_mu_ratio7Inf.at(4)->GetMean());
    MuAccUnc_NJets7Inf->SetBinError(2,2, calcUnc2Max(h_mu_ratio7Inf.at(4)));
    MuAccUnc_NJets7Inf->SetBinContent(3,2, h_mu_ratio7Inf.at(5)->GetMean());
    MuAccUnc_NJets7Inf->SetBinError(3,2, calcUnc2Max(h_mu_ratio7Inf.at(5)));
    MuAccUnc_NJets7Inf->SetBinContent(2,3, h_mu_ratio7Inf.at(6)->GetMean());
    MuAccUnc_NJets7Inf->SetBinError(2,3, calcUnc2Max(h_mu_ratio7Inf.at(6)));
    MuAccUnc_NJets7Inf->SetBinContent(3,3, h_mu_ratio7Inf.at(7)->GetMean());
    MuAccUnc_NJets7Inf->SetBinError(3,3, calcUnc2Max(h_mu_ratio7Inf.at(7)));

    ElecAccUnc_NJets3->SetBinContent(1,1, h_elec_ratio3.at(0)->GetMean());
    ElecAccUnc_NJets3->SetBinError(1,1, calcUnc2Max(h_elec_ratio3.at(0)));
    ElecAccUnc_NJets3->SetBinContent(2,1, h_elec_ratio3.at(1)->GetMean());
    ElecAccUnc_NJets3->SetBinError(2,1, calcUnc2Max(h_elec_ratio3.at(1)));
    ElecAccUnc_NJets3->SetBinContent(3,1, h_elec_ratio3.at(2)->GetMean());
    ElecAccUnc_NJets3->SetBinError(3,1, calcUnc2Max(h_elec_ratio3.at(2)));
    ElecAccUnc_NJets3->SetBinContent(1,2, h_elec_ratio3.at(3)->GetMean());
    ElecAccUnc_NJets3->SetBinError(1,2, calcUnc2Max(h_elec_ratio3.at(3)));
    ElecAccUnc_NJets3->SetBinContent(2,2, h_elec_ratio3.at(4)->GetMean());
    ElecAccUnc_NJets3->SetBinError(2,2, calcUnc2Max(h_elec_ratio3.at(4)));
    ElecAccUnc_NJets3->SetBinContent(3,2, h_elec_ratio3.at(5)->GetMean());
    ElecAccUnc_NJets3->SetBinError(3,2, calcUnc2Max(h_elec_ratio3.at(5)));
    ElecAccUnc_NJets3->SetBinContent(2,3, h_elec_ratio3.at(6)->GetMean());
    ElecAccUnc_NJets3->SetBinError(2,3, calcUnc2Max(h_elec_ratio3.at(6)));
    ElecAccUnc_NJets3->SetBinContent(3,3, h_elec_ratio3.at(7)->GetMean());
    ElecAccUnc_NJets3->SetBinError(3,3, calcUnc2Max(h_elec_ratio3.at(7)));
    ElecAccUnc_NJets4->SetBinContent(1,1, h_elec_ratio4.at(0)->GetMean());
    ElecAccUnc_NJets4->SetBinError(1,1, calcUnc2Max(h_elec_ratio4.at(0)));
    ElecAccUnc_NJets4->SetBinContent(2,1, h_elec_ratio4.at(1)->GetMean());
    ElecAccUnc_NJets4->SetBinError(2,1, calcUnc2Max(h_elec_ratio4.at(1)));
    ElecAccUnc_NJets4->SetBinContent(3,1, h_elec_ratio4.at(2)->GetMean());
    ElecAccUnc_NJets4->SetBinError(3,1, calcUnc2Max(h_elec_ratio4.at(2)));
    ElecAccUnc_NJets4->SetBinContent(1,2, h_elec_ratio4.at(3)->GetMean());
    ElecAccUnc_NJets4->SetBinError(1,2, calcUnc2Max(h_elec_ratio4.at(3)));
    ElecAccUnc_NJets4->SetBinContent(2,2, h_elec_ratio4.at(4)->GetMean());
    ElecAccUnc_NJets4->SetBinError(2,2, calcUnc2Max(h_elec_ratio4.at(4)));
    ElecAccUnc_NJets4->SetBinContent(3,2, h_elec_ratio4.at(5)->GetMean());
    ElecAccUnc_NJets4->SetBinError(3,2, calcUnc2Max(h_elec_ratio4.at(5)));
    ElecAccUnc_NJets4->SetBinContent(2,3, h_elec_ratio4.at(6)->GetMean());
    ElecAccUnc_NJets4->SetBinError(2,3, calcUnc2Max(h_elec_ratio4.at(6)));
    ElecAccUnc_NJets4->SetBinContent(3,3, h_elec_ratio4.at(7)->GetMean());
    ElecAccUnc_NJets4->SetBinError(3,3, calcUnc2Max(h_elec_ratio4.at(7)));
    ElecAccUnc_NJets5->SetBinContent(1,1, h_elec_ratio5.at(0)->GetMean());
    ElecAccUnc_NJets5->SetBinError(1,1, calcUnc2Max(h_elec_ratio5.at(0)));
    ElecAccUnc_NJets5->SetBinContent(2,1, h_elec_ratio5.at(1)->GetMean());
    ElecAccUnc_NJets5->SetBinError(2,1, calcUnc2Max(h_elec_ratio5.at(1)));
    ElecAccUnc_NJets5->SetBinContent(3,1, h_elec_ratio5.at(2)->GetMean());
    ElecAccUnc_NJets5->SetBinError(3,1, calcUnc2Max(h_elec_ratio5.at(2)));
    ElecAccUnc_NJets5->SetBinContent(1,2, h_elec_ratio5.at(3)->GetMean());
    ElecAccUnc_NJets5->SetBinError(1,2, calcUnc2Max(h_elec_ratio5.at(3)));
    ElecAccUnc_NJets5->SetBinContent(2,2, h_elec_ratio5.at(4)->GetMean());
    ElecAccUnc_NJets5->SetBinError(2,2, calcUnc2Max(h_elec_ratio5.at(4)));
    ElecAccUnc_NJets5->SetBinContent(3,2, h_elec_ratio5.at(5)->GetMean());
    ElecAccUnc_NJets5->SetBinError(3,2, calcUnc2Max(h_elec_ratio5.at(5)));
    ElecAccUnc_NJets5->SetBinContent(2,3, h_elec_ratio5.at(6)->GetMean());
    ElecAccUnc_NJets5->SetBinError(2,3, calcUnc2Max(h_elec_ratio5.at(6)));
    ElecAccUnc_NJets5->SetBinContent(3,3, h_elec_ratio5.at(7)->GetMean());
    ElecAccUnc_NJets5->SetBinError(3,3, calcUnc2Max(h_elec_ratio5.at(7)));
    ElecAccUnc_NJets6->SetBinContent(1,1, h_elec_ratio6.at(0)->GetMean());
    ElecAccUnc_NJets6->SetBinError(1,1, calcUnc2Max(h_elec_ratio6.at(0)));
    ElecAccUnc_NJets6->SetBinContent(2,1, h_elec_ratio6.at(1)->GetMean());
    ElecAccUnc_NJets6->SetBinError(2,1, calcUnc2Max(h_elec_ratio6.at(1)));
    ElecAccUnc_NJets6->SetBinContent(3,1, h_elec_ratio6.at(2)->GetMean());
    ElecAccUnc_NJets6->SetBinError(3,1, calcUnc2Max(h_elec_ratio6.at(2)));
    ElecAccUnc_NJets6->SetBinContent(1,2, h_elec_ratio6.at(3)->GetMean());
    ElecAccUnc_NJets6->SetBinError(1,2, calcUnc2Max(h_elec_ratio6.at(3)));
    ElecAccUnc_NJets6->SetBinContent(2,2, h_elec_ratio6.at(4)->GetMean());
    ElecAccUnc_NJets6->SetBinError(2,2, calcUnc2Max(h_elec_ratio6.at(4)));
    ElecAccUnc_NJets6->SetBinContent(3,2, h_elec_ratio6.at(5)->GetMean());
    ElecAccUnc_NJets6->SetBinError(3,2, calcUnc2Max(h_elec_ratio6.at(5)));
    ElecAccUnc_NJets6->SetBinContent(2,3, h_elec_ratio6.at(6)->GetMean());
    ElecAccUnc_NJets6->SetBinError(2,3, calcUnc2Max(h_elec_ratio6.at(6)));
    ElecAccUnc_NJets6->SetBinContent(3,3, h_elec_ratio6.at(7)->GetMean());
    ElecAccUnc_NJets6->SetBinError(3,3, calcUnc2Max(h_elec_ratio6.at(7)));
    ElecAccUnc_NJets78->SetBinContent(1,1, h_elec_ratio78.at(0)->GetMean());
    ElecAccUnc_NJets78->SetBinError(1,1, calcUnc2Max(h_elec_ratio78.at(0)));
    ElecAccUnc_NJets78->SetBinContent(2,1, h_elec_ratio78.at(1)->GetMean());
    ElecAccUnc_NJets78->SetBinError(2,1, calcUnc2Max(h_elec_ratio78.at(1)));
    ElecAccUnc_NJets78->SetBinContent(3,1, h_elec_ratio78.at(2)->GetMean());
    ElecAccUnc_NJets78->SetBinError(3,1, calcUnc2Max(h_elec_ratio78.at(2)));
    ElecAccUnc_NJets78->SetBinContent(1,2, h_elec_ratio78.at(3)->GetMean());
    ElecAccUnc_NJets78->SetBinError(1,2, calcUnc2Max(h_elec_ratio78.at(3)));
    ElecAccUnc_NJets78->SetBinContent(2,2, h_elec_ratio78.at(4)->GetMean());
    ElecAccUnc_NJets78->SetBinError(2,2, calcUnc2Max(h_elec_ratio78.at(4)));
    ElecAccUnc_NJets78->SetBinContent(3,2, h_elec_ratio78.at(5)->GetMean());
    ElecAccUnc_NJets78->SetBinError(3,2, calcUnc2Max(h_elec_ratio78.at(5)));
    ElecAccUnc_NJets78->SetBinContent(2,3, h_elec_ratio78.at(6)->GetMean());
    ElecAccUnc_NJets78->SetBinError(2,3, calcUnc2Max(h_elec_ratio78.at(6)));
    ElecAccUnc_NJets78->SetBinContent(3,3, h_elec_ratio78.at(7)->GetMean());
    ElecAccUnc_NJets78->SetBinError(3,3, calcUnc2Max(h_elec_ratio78.at(7)));
    ElecAccUnc_NJets9Inf->SetBinContent(1,1, h_elec_ratio9Inf.at(0)->GetMean());
    ElecAccUnc_NJets9Inf->SetBinError(1,1, calcUnc2Max(h_elec_ratio9Inf.at(0)));
    ElecAccUnc_NJets9Inf->SetBinContent(2,1, h_elec_ratio9Inf.at(1)->GetMean());
    ElecAccUnc_NJets9Inf->SetBinError(2,1, calcUnc2Max(h_elec_ratio9Inf.at(1)));
    ElecAccUnc_NJets9Inf->SetBinContent(3,1, h_elec_ratio9Inf.at(2)->GetMean());
    ElecAccUnc_NJets9Inf->SetBinError(3,1, calcUnc2Max(h_elec_ratio9Inf.at(2)));
    ElecAccUnc_NJets9Inf->SetBinContent(1,2, h_elec_ratio9Inf.at(3)->GetMean());
    ElecAccUnc_NJets9Inf->SetBinError(1,2, calcUnc2Max(h_elec_ratio9Inf.at(3)));
    ElecAccUnc_NJets9Inf->SetBinContent(2,2, h_elec_ratio9Inf.at(4)->GetMean());
    ElecAccUnc_NJets9Inf->SetBinError(2,2, calcUnc2Max(h_elec_ratio9Inf.at(4)));
    ElecAccUnc_NJets9Inf->SetBinContent(3,2, h_elec_ratio9Inf.at(5)->GetMean());
    ElecAccUnc_NJets9Inf->SetBinError(3,2, calcUnc2Max(h_elec_ratio9Inf.at(5)));
    ElecAccUnc_NJets9Inf->SetBinContent(2,3, h_elec_ratio9Inf.at(6)->GetMean());
    ElecAccUnc_NJets9Inf->SetBinError(2,3, calcUnc2Max(h_elec_ratio9Inf.at(6)));
    ElecAccUnc_NJets9Inf->SetBinContent(3,3, h_elec_ratio9Inf.at(7)->GetMean());
    ElecAccUnc_NJets9Inf->SetBinError(3,3, calcUnc2Max(h_elec_ratio9Inf.at(7)));
    ElecAccUnc_NJets7Inf->SetBinContent(1,1, h_elec_ratio7Inf.at(0)->GetMean());
    ElecAccUnc_NJets7Inf->SetBinError(1,1, calcUnc2Max(h_elec_ratio7Inf.at(0)));
    ElecAccUnc_NJets7Inf->SetBinContent(2,1, h_elec_ratio7Inf.at(1)->GetMean());
    ElecAccUnc_NJets7Inf->SetBinError(2,1, calcUnc2Max(h_elec_ratio7Inf.at(1)));
    ElecAccUnc_NJets7Inf->SetBinContent(3,1, h_elec_ratio7Inf.at(2)->GetMean());
    ElecAccUnc_NJets7Inf->SetBinError(3,1, calcUnc2Max(h_elec_ratio7Inf.at(2)));
    ElecAccUnc_NJets7Inf->SetBinContent(1,2, h_elec_ratio7Inf.at(3)->GetMean());
    ElecAccUnc_NJets7Inf->SetBinError(1,2, calcUnc2Max(h_elec_ratio7Inf.at(3)));
    ElecAccUnc_NJets7Inf->SetBinContent(2,2, h_elec_ratio7Inf.at(4)->GetMean());
    ElecAccUnc_NJets7Inf->SetBinError(2,2, calcUnc2Max(h_elec_ratio7Inf.at(4)));
    ElecAccUnc_NJets7Inf->SetBinContent(3,2, h_elec_ratio7Inf.at(5)->GetMean());
    ElecAccUnc_NJets7Inf->SetBinError(3,2, calcUnc2Max(h_elec_ratio7Inf.at(5)));
    ElecAccUnc_NJets7Inf->SetBinContent(2,3, h_elec_ratio7Inf.at(6)->GetMean());
    ElecAccUnc_NJets7Inf->SetBinError(2,3, calcUnc2Max(h_elec_ratio7Inf.at(6)));
    ElecAccUnc_NJets7Inf->SetBinContent(3,3, h_elec_ratio7Inf.at(7)->GetMean());
    ElecAccUnc_NJets7Inf->SetBinError(3,3, calcUnc2Max(h_elec_ratio7Inf.at(7)));

    MuAccUnc_Avg->SetBinContent(1,1, h_mu_ratioAvg.at(0)->GetMean());
    MuAccUnc_Avg->SetBinError(1,1, calcUnc2Max(h_mu_ratioAvg.at(0)));
    MuAccUnc_Avg->SetBinContent(2,1, h_mu_ratioAvg.at(1)->GetMean());
    MuAccUnc_Avg->SetBinError(2,1, calcUnc2Max(h_mu_ratioAvg.at(1)));
    MuAccUnc_Avg->SetBinContent(3,1, h_mu_ratioAvg.at(2)->GetMean());
    MuAccUnc_Avg->SetBinError(3,1, calcUnc2Max(h_mu_ratioAvg.at(2)));
    MuAccUnc_Avg->SetBinContent(1,2, h_mu_ratioAvg.at(3)->GetMean());
    MuAccUnc_Avg->SetBinError(1,2, calcUnc2Max(h_mu_ratioAvg.at(3)));
    MuAccUnc_Avg->SetBinContent(2,2, h_mu_ratioAvg.at(4)->GetMean());
    MuAccUnc_Avg->SetBinError(2,2, calcUnc2Max(h_mu_ratioAvg.at(4)));
    MuAccUnc_Avg->SetBinContent(3,2, h_mu_ratioAvg.at(5)->GetMean());
    MuAccUnc_Avg->SetBinError(3,2, calcUnc2Max(h_mu_ratioAvg.at(5)));
    MuAccUnc_Avg->SetBinContent(2,3, h_mu_ratioAvg.at(6)->GetMean());
    MuAccUnc_Avg->SetBinError(2,3, calcUnc2Max(h_mu_ratioAvg.at(6)));
    MuAccUnc_Avg->SetBinContent(3,3, h_mu_ratioAvg.at(7)->GetMean());
    MuAccUnc_Avg->SetBinError(3,3, calcUnc2Max(h_mu_ratioAvg.at(7)));
    ElecAccUnc_Avg->SetBinContent(1,1, h_elec_ratioAvg.at(0)->GetMean());
    ElecAccUnc_Avg->SetBinError(1,1, calcUnc2Max(h_elec_ratioAvg.at(0)));
    ElecAccUnc_Avg->SetBinContent(2,1, h_elec_ratioAvg.at(1)->GetMean());
    ElecAccUnc_Avg->SetBinError(2,1, calcUnc2Max(h_elec_ratioAvg.at(1)));
    ElecAccUnc_Avg->SetBinContent(3,1, h_elec_ratioAvg.at(2)->GetMean());
    ElecAccUnc_Avg->SetBinError(3,1, calcUnc2Max(h_elec_ratioAvg.at(2)));
    ElecAccUnc_Avg->SetBinContent(1,2, h_elec_ratioAvg.at(3)->GetMean());
    ElecAccUnc_Avg->SetBinError(1,2, calcUnc2Max(h_elec_ratioAvg.at(3)));
    ElecAccUnc_Avg->SetBinContent(2,2, h_elec_ratioAvg.at(4)->GetMean());
    ElecAccUnc_Avg->SetBinError(2,2, calcUnc2Max(h_elec_ratioAvg.at(4)));
    ElecAccUnc_Avg->SetBinContent(3,2, h_elec_ratioAvg.at(5)->GetMean());
    ElecAccUnc_Avg->SetBinError(3,2, calcUnc2Max(h_elec_ratioAvg.at(5)));
    ElecAccUnc_Avg->SetBinContent(2,3, h_elec_ratioAvg.at(6)->GetMean());
    ElecAccUnc_Avg->SetBinError(2,3, calcUnc2Max(h_elec_ratioAvg.at(6)));
    ElecAccUnc_Avg->SetBinContent(3,3, h_elec_ratioAvg.at(7)->GetMean());
    ElecAccUnc_Avg->SetBinError(3,3, calcUnc2Max(h_elec_ratioAvg.at(7)));

    MuAccUnc_NJets->SetBinContent(1, h_mu_ratioNJets.at(0)->GetMean());
    MuAccUnc_NJets->SetBinError(1, calcUnc2Max(h_mu_ratioNJets.at(0)));
    MuAccUnc_NJets->SetBinContent(2, h_mu_ratioNJets.at(1)->GetMean());
    MuAccUnc_NJets->SetBinError(2, calcUnc2Max(h_mu_ratioNJets.at(1)));
    MuAccUnc_NJets->SetBinContent(3, h_mu_ratioNJets.at(2)->GetMean());
    MuAccUnc_NJets->SetBinError(3, calcUnc2Max(h_mu_ratioNJets.at(2)));
    MuAccUnc_NJets->SetBinContent(4, h_mu_ratioNJets.at(3)->GetMean());
    MuAccUnc_NJets->SetBinError(4, calcUnc2Max(h_mu_ratioNJets.at(3)));
    MuAccUnc_NJets->SetBinContent(5, h_mu_ratioNJets.at(4)->GetMean());
    MuAccUnc_NJets->SetBinError(5, calcUnc2Max(h_mu_ratioNJets.at(4)));
    MuAccUnc_NJets->SetBinContent(6, h_mu_ratioNJets.at(5)->GetMean());
    MuAccUnc_NJets->SetBinError(6, calcUnc2Max(h_mu_ratioNJets.at(5)));

    ElecAccUnc_NJets->SetBinContent(1, h_elec_ratioNJets.at(0)->GetMean());
    ElecAccUnc_NJets->SetBinError(1, calcUnc2Max(h_elec_ratioNJets.at(0)));
    ElecAccUnc_NJets->SetBinContent(2, h_elec_ratioNJets.at(1)->GetMean());
    ElecAccUnc_NJets->SetBinError(2, calcUnc2Max(h_elec_ratioNJets.at(1)));
    ElecAccUnc_NJets->SetBinContent(3, h_elec_ratioNJets.at(2)->GetMean());
    ElecAccUnc_NJets->SetBinError(3, calcUnc2Max(h_elec_ratioNJets.at(2)));
    ElecAccUnc_NJets->SetBinContent(4, h_elec_ratioNJets.at(3)->GetMean());
    ElecAccUnc_NJets->SetBinError(4, calcUnc2Max(h_elec_ratioNJets.at(3)));
    ElecAccUnc_NJets->SetBinContent(5, h_elec_ratioNJets.at(4)->GetMean());
    ElecAccUnc_NJets->SetBinError(5, calcUnc2Max(h_elec_ratioNJets.at(4)));
    ElecAccUnc_NJets->SetBinContent(6, h_elec_ratioNJets.at(5)->GetMean());
    ElecAccUnc_NJets->SetBinError(6, calcUnc2Max(h_elec_ratioNJets.at(5)));
    ...
    TFile *outPutFile = new TFile("AcceptanceUncertainty/PDFuncertainty.root","RECREATE"); 
	outPutFile->cd();
