...
class BTagCalibrationReaderNew::BTagCalibrationReaderImpl
{
  friend class BTagCalibrationReaderNew;
...
BTagCalibrationReaderNew::BTagCalibrationReaderImpl::BTagCalibrationReaderImpl(
                                             BTagEntry::OperatingPoint op,
                                             const std::string & sysType):
  op_(op),
  sysType_(sysType),
...
void BTagCalibrationReaderNew::BTagCalibrationReaderImpl::load(
...
double BTagCalibrationReaderNew::BTagCalibrationReaderImpl::eval(
                                             BTagEntry::JetFlavor jf,
                                             float eta,
                                             float pt,
                                             float discr) const
...
double BTagCalibrationReaderNew::BTagCalibrationReaderImpl::eval_auto_bounds(
...
std::pair<float, float> BTagCalibrationReaderNew::BTagCalibrationReaderImpl::min_max_pt(
                                               BTagEntry::JetFlavor jf,
                                               float eta,
                                               float discr) const
{
...
BTagCalibrationReaderNew::BTagCalibrationReaderNew(BTagEntry::OperatingPoint op,
                                             const std::string & sysType):
...
void BTagCalibrationReaderNew::load(const BTagCalibration & c,
                                 BTagEntry::JetFlavor jf,
...
double BTagCalibrationReaderNew::eval(BTagEntry::JetFlavor jf,
                                   float eta,
                                   float pt,
                                   float discr) const
{
...
double BTagCalibrationReaderNew::eval_auto_bounds(const std::string & sys,
                                               BTagEntry::JetFlavor jf,
                                               float eta,
                                               float pt,
                                               float discr) const
...
std::pair<float, float> BTagCalibrationReaderNew::min_max_pt(BTagEntry::JetFlavor jf,
                                                          float eta,
                                                          float discr) const
{
