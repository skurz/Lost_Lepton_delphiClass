...
void MakeTagAndProbe()
{
	...
	Effchain->Add("/nfs/dust/cms/user/kurzsimo/LostLepton/mc/DYJetsToLL_M-50_HT-100to200/*root");
	Effchain->Add("/nfs/dust/cms/user/kurzsimo/LostLepton/mc/DYJetsToLL_M-50_HT-200to400/*root");
	Effchain->Add("/nfs/dust/cms/user/kurzsimo/LostLepton/mc/DYJetsToLL_M-50_HT-400to600/*root");
	Effchain->Add("/nfs/dust/cms/user/kurzsimo/LostLepton/mc/DYJetsToLL_M-50_HT-600toInf/*root");
...
//  	Effchain->Process("/afs/desy.de/user/a/adraeger/2015/TagAndProbe.C++g",0,800000);
 	Effchain->Process("/afs/desy.de/user/k/kurzsimo/xxl-af-cms/CMSSW_7_2_3_patch1/src/Lost-Lepton/TagAndProbe.C++g");
 	         	Effchain->SetProof(0);
 	        	delete proof;
}
