...
void Plot_searchBin_full_lowNJets(string option="", int pull=0){ // string option="QCD"
  ...
  double search_x_max=108.-0.5;
  if(option.find("QCD")!=string::npos)search_x_max=286.-0.5;
  ...
  if(option.find("QCD")==string::npos ){
    ...
    */
    ...
    ttext_njet->DrawLatex(96.-0.5 , ymax_top/4. , "N_{#scale[0.2]{ }jet} #geq 9");
    ...
    tl_nb->DrawLine(49.-0.5,ymin_top,49.-0.5,ymax2_top); 
    tl_nb->DrawLine(55.-0.5,ymin_top,55.-0.5,ymax2_top); 
    tl_nb->DrawLine(61.-0.5,ymin_top,61.-0.5,ymax2_top); 
    tl_nb->DrawLine(67.-0.5,ymin_top,67.-0.5,ymax3_top);
    tl_nb->DrawLine(73.-0.5,ymin_top,73.-0.5,ymax3_top);
    tl_nb->DrawLine(79.-0.5,ymin_top,79.-0.5,ymax3_top);
    tl_nb->DrawLine(85.-0.5,ymin_top,85.-0.5,ymax3_top);
    ...
    tl_nb->DrawLine(109.-0.5,ymin_top,109.-0.5,ymax4_top);
    ...
    ttext_nb->DrawLatex(40.-0.5 , ymax_top/12. , "N_{#scale[0.2]{ }b-jet}");
  ...
  // ----------
	...
	//tline0->Draw();
      ...
      tl_nb->DrawLine(85.-0.5,ymin_bottom,85.-0.5,ymax2_bottom);
      ...
      tl_nb->DrawLine(109.-0.5,ymin_bottom,109.-0.5,ymax2_bottom);
