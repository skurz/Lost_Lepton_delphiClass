...
void MakePrediction_separate()
{
  ...
  /*  else{
      Effchain[i]->Process("Prediction", TString::Format("Prediction_separate/Prediction_%d_1.root",i), 4000000, 0);
      Effchain[i]->Process("Prediction", TString::Format("Prediction_separate/Prediction_%d_2.root",i), TChain::kBigNumber, 4000001);
    }
  */}
}
